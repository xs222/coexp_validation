...
############# ROSMAP
# cor estimations
ROSMAP_est <- readRDS("revision/estimate_cor_lung/mono/est_cor.rds")
...
for (i in 1:n_permu){
  print(i)
  path <- paste0("revision/estimate_cor_lung/simu_IND_Monocyte/est_cor_s", i, ".rds")
...
saveRDS(p_val, paste0("revision/estimate_cor_lung/mono/norm_p.rds"))
