...
gene_name <- colnames(rosmap_ests$est)

############# ROSMAP
# cor estimations
ROSMAP_est <- readRDS("revision/estimate_cor_PNAS_same_gene/oli/est_cor.rds")
...
for (i in 1:n_permu){
  print(i)
  path <- paste0("revision/estimate_cor_PNAS_same_gene/simu_IND_oli/est_cor_s", i, ".rds")
...
saveRDS(p_val, paste0("revision/estimate_cor_PNAS_same_gene/oli/norm_p.rds"))
