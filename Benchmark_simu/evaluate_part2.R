...
eval_result <- readRDS(paste0("compare_simulation/compare_simu_multi_data/evaluation/", data_name, "_eval.rds"))


simu_method <- c("NB", "POWSC", "scDesign2", "SymSim", "ZINB_WaVE",
                 "powsimR", "Splat", "SCRIP", "muscat", "SPARSim", "hierarchicell")
...
saveRDS(ks_stat, paste0("compare_simulation/compare_simu_multi_data/evaluation/", data_name, "_eval_ks.rds"))

kde_stat <- as.data.frame(kde_stat)
kde_stat$data <- data_name
saveRDS(kde_stat, paste0("compare_simulation/compare_simu_multi_data/evaluation/", data_name, "_eval_kde.rds"))
