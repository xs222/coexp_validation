...
# scDesign3 --------------------------------------------------------------------
print("scDesign3 --------------------------------------------------------------------")               
scdesign3_simu = readRDS(paste0(path,"simu_scDesign3_ind.rds"))   
...
# scSimu --------------------------------------------------------------------
print("scSimu --------------------------------------------------------------------")                  
scsimu_simu = readRDS(paste0(path,"simu_scSimu_ind.rds"))
scsimu_simu = scsimu_simu[rownames(count_sub), colnames(count_sub)]
eval_result[["scSimu"]] <- eval_fun(scsimu_simu, gene_info)

saveRDS(eval_result, "/gpfs/gibbs/pi/zhao/xs282/validation/revision/smart_seq_data/simu/cyto_t/eval_res_ind.rds")
...
saveRDS(list(ks=ks_stat, kde=kde_stat), "/gpfs/gibbs/pi/zhao/xs282/validation/revision/smart_seq_data/simu/cyto_t/ks_kde_ind.rds")
